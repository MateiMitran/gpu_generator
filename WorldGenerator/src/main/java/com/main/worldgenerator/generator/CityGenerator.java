...
import com.main.worldgenerator.generator.city.CityBlockPopulator;
import com.main.worldgenerator.generator.city.Fountain;
import com.main.worldgenerator.populators.OrePopulator;
import com.main.worldgenerator.populators.StreetlightPopulator;
 ...
 * @author Nightgunner5
 */
public class CityGenerator extends NewChunkGeneratorGPU {
	{
	...
	public CityGenerator(Core core) {
		super(core);
	}
